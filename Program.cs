...
class MyFirstConsoleApplication
{
    static void Main()
    {
        ...
        Console.WriteLine($"There are {untilChristmas.TotalDays} day(s) until Christmas ({christmas.ToString("dddd, MM/dd/yyyy")})");
        ...
        //Calculate the amount of wood and glass needed
